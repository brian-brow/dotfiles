...
hl.window_rule({ match = { class = "^(yazi-floating)" }, float = true, size = { 1600, 1000 } })
hl.window_rule({ match = { class = "^(yazi-floating)" }, center = true })
hl.window_rule({ match = { class = "^(yazi-floating)" }, move = "%50 0 " })
